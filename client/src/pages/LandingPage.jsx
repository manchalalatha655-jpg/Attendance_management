            ...
            <div style={{
                ...
                <div style={{ width: '100%', maxWidth: '440px' }}>
                    ...
                    <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                        ...
                        >
                            {loading ? 'Authenticating...' : 'Login Into Account'} <FiArrowRight />
                        </button>
                    </form>

                    <div style={{ marginTop: '32px', textAlign: 'center' }}>
                        <p style={{ fontSize: '14px', color: '#64748b', fontWeight: '600' }}>
                            Need a new faculty or student account? <br />
                            <Link to="/register" style={{ color: '#0E2F76', fontWeight: '800', textDecoration: 'none' }}>Access Registration Portal</Link>
                        </p>
                    </div>
                </div>
            </div>

...
const Timetable = () => {
    ...
    const schedule = [
        { day: 'Monday', time: '09:00 AM', subject: 'Data Structures', class: 'CS-101 (A)', room: 'R302' },
        { day: 'Monday', time: '11:00 AM', subject: 'Java Lab', class: 'CS-102 (B)', room: 'L01' },
        { day: 'Tuesday', time: '10:00 AM', subject: 'DBMS', class: 'CS-203 (A)', room: 'R205' },
        { day: 'Wednesday', time: '09:00 AM', subject: 'Data Structures', class: 'CS-101 (A)', room: 'R302' },
        { day: 'Thursday', time: '11:00 AM', subject: 'Java Lab', class: 'CS-102 (B)', room: 'L01' },
        { day: 'Friday', time: '02:00 PM', subject: 'DBMS', class: 'CS-203 (A)', room: 'R205' },
    ];
    ...
    return (
        <div className="animate-fade-in">
            <div style={{ marginBottom: '32px' }}>
                <h2 style={{ fontSize: '28px', fontWeight: '800', color: 'var(--primary-accent)', marginBottom: '8px' }}>Weekly Timetable</h2>
                <p style={{ color: 'var(--text-light)' }}>Your complete academic schedule for the current semester.</p>
            </div>
                                        ...
                                        <td key={day} style={{ padding: '10px', borderRight: '1px solid var(--glass-border)', borderBottom: '1px solid var(--glass-border)', height: '100px' }}>
                                            {entry ? (
                                                <div style={{ 
                                                    ...
                                                    <div style={{ opacity: 0.8, fontSize: '11px' }}>{entry.class}</div>
                                                    <div style={{ marginTop: '6px', fontSize: '10px', display: 'flex', alignItems: 'center', gap: '4px' }}>
                                                        <FiMapPin size={10} /> {entry.room}
                                                    </div>
                                                </div>
                                            ) : (
                                                <div style={{ height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'var(--text-light)', opacity: 0.2 }}>
                                                    <FiClock size={20} />
                                                </div>
                                            )}
                                        </td>
